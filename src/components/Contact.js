...
function Contact() {
  return (
    <div className="contact-container">
      ...
      <p>Whether you have a question about my work, want to collaborate on a project, or just want to say hi, don't hesitate to contact me!</p>
      <p>I'm looking forward to hearing from you!</p>
      <p>Here are some ways to reach me:</p> */}
      <ul>
        <li>Email: <a href="mailto:kalyanchakravarthymalyala@gmail.com">kalyanchakravarthymalyala@gmail.com</a></li>
